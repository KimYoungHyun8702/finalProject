...
$(document).on("click", "#insertBtn", function(){
	...
	$.ajax({
		"url":"/project_mugs/professor/registerSubjectPlan.do",
		"type":"POST",
		"data":{"planSummary":planSummary,"planMarkingMethod":planMarkingMethod,"planLessonGoal":planLessonGoal,"planWeekContent":planWeekContent,"planBookinfo":planBookinfo,"planBibliography":planBibliography,"planYear":planYear,"planSemester":planSemester,"planNote":planNote,"proId":proId,"subjectId":subjectId,${_csrf.parameterName}:'${_csrf.token}'},
		"success":function(){
			alert("등록완료");
		},//success
		"error":function(){		
