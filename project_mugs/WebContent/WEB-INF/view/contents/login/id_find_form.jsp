            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="${initParam.rootPath}/admin/idFind.do" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="성명" type="text" id="name" name="name" autofocus><br>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="주민등록번호 앞자리" type="number" id="rrn1" name="rrn1">-<input class="form-control" placeholder="주민등록번호 뒷자리" type="number" id="rrn2" name="rrn2">
                                </div>
                                <div class="checkbox">
                                    <label>
