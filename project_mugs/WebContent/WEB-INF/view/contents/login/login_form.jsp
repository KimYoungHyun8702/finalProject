...
<body>
<!-- <h1><img style="margin-left: 155px;" src="resource/up_image/logo.png"></h1> -->
  ...
  <form id="login_form">
    ...
    <span class="button_text">로그인</span>
    </button>
    
    <div id="sign_in_options" class="field_container">
        <div id="sign_in_alternatives_container">
          <span id="google_sign_in_option"><a href="#" id="google_sign_in" class="login_link">아이디찾기</a></span>
          <span id="password_sign_in_option"><a href="#" id="password_sign_in" class="login_link">sign in using a password</a></span>
           <span id="google_sign_in_option"><a href="#" id="google_sign_in" class="login_link">비밀번호찾기</a></span>
          <span id="password_sign_in_option"><a href="#" id="password_sign_in" class="login_link">sign in using a password</a></span>
        </div>
