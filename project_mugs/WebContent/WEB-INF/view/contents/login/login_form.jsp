...
textarea.error:not(.basic) { border-color: #ffb937 !important }
...
body>#pricing h1 a:hover {
    box-shadow: 0 0 0 1px #ffb937;
    -moz-box-shadow: 0 0 0 1px #ffb937;
    -webkit-box-shadow: 0 0 0 1px #ffb937;
...
#signup_form .switch_signup_method .alt_signup_link:hover { color: #ffb937 }
...
body>#login {
    ...
    border-top: 8px solid #ffb937;
    border-bottom: 8px solid #ffb937;
    margin-top:150px;
    padding: 0 0 70px;
    width: 100%;
}
...
body>#login form .login_link:hover { color: #ffb937 }
body>#login form#login_form input[type=text],
body>#login form#login_form input[type=userId],
body>#login form#login_form input[type=password] { width: 400px }
...
body>#login form#login_form #sign_in_options #sign_in_alternatives_container a { margin-left: 5px }
...
body>#login #chrome_web_store a:hover { border-bottom: 2px solid #ffb937 }
...
body>#login #dont_have_an_account a:hover { border-bottom: 2px solid #ffb937 }
    </style>
...
<c:if test="${not empty param.errorMessage}">
  ...
  <div id="login">
  <form id="login_form" action="${initParam.rootPath}/login.do" method="post">
  <div id="test" style="float: left;">
    <div class="field_container">
      <input type="text" name="userId" placeholder="아이디" style="width: 300px; height: 5px;">
    </div>
    
    <div class="field_container">
      <input name="userPassword" type="password" placeholder="비밀번호" style="width: 300px; height: 5px;">
    </div>
    </div><!-- test end -->
    <div id="logot" style="float: left;">
    <a href="javascript:;" onclick="document.getElementById('login_form').submit();">
	<img alt="https://image.flaticon.com/icons/svg/210/210118.svg" src="https://image.flaticon.com/icons/svg/210/210118.svg" width="110px" height="85px">
    </a>
    </div>
    <div id="sign_in_options" class="field_container">
        <div id="sign_in_alternatives_container">
          <span id="google_sign_in_option"><a href="javascript:popupOpen('${initParam.rootPath }/idFind.do');" id="google_sign_in" class="login_link">아이디찾기</a></span>
           <span id="google_sign_in_option"><a href="javascript:popupOpen('${initParam.rootPath }/pwFind.do');" id="google_sign_in" class="login_link">비밀번호찾기</a></span>
        </div>
