...
<form action="${initParam.rootPath}/student/updateStuAndSelect.do?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data"  onsubmit="return check();">
	...
	<table border="2">
		...
		<thead>
			<tr>
				<td rowspan="4" style="height: 34px; text-align:center;" id="imageSpace"><c:choose>
				...
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.stuId}</td>
			</tr>
			<tr>
				<th align="center"><input type="text" style="height: 40px"class="form-control" placeholder="이름" disabled></th>
				<td style="height: 34px; text-align:center; ">${requestScope.reFormDateStu.stuInfo.usersName}</td>
			</tr>
			<tr>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="영문 이름" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.usersEngName}</td>
			</tr>
			<tr>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="주민 번호" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.usersRRN}</td>
			</tr>
		</thead>
	</table><br>
	...
	<table border="2">
		...
		<thead>
			<tr>
	   			...
	   			<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.stuCourse}</td>
	   			<th align="center" ><input type="text" style="height: 40px" class="form-control" placeholder="병영 구분" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.stuArmy}</td>
	   		</tr>
	   		<tr>
	   			<th align="center" ><input type="text" style="height: 40px" class="form-control" placeholder="학년" disabled></th>
	   			<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.stuGrade}</td><!-- 학년 -->
	   			<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="학기" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.stuSemester}</td><!-- 학기 -->
	   		</tr>
	   		<tr>
	   			<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="학적 구분" disabled></th>
	   			<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.stuRegisterState}</td>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="학생 구분" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.stuStudentState}</td>
			</tr>
			<tr>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="입학 일자" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuAdmissionDate}</td><!-- 입학일자 -->
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="졸업 일자" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuGraduationDate}</td><!-- 졸업일자 -->
			</tr>
			<tr>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="조기졸업 대상 여부" disabled></th>
				<td style="height: 34px; text-align:center;">${(requestScope.reFormDateStu.stuInfo.stuEarlyGraduation=='y')?'조기졸업가능':'조기졸업불가'}</td>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="소속 학과" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.mainMajor.majorName}</td><!-- 주전공 -->
			</tr>
			<tr>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="복수 전공" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.multiMajor.majorName}</td>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="부전공" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.subMajor.majorName}</td><!-- 부전공 -->
			</tr>
		</thead>
	</table><br>
	...
	<table border="2">
		...
		<thead>
			<tr>
				...
				<td colspan="5" style="height: 34px; text-align:center;"><input type="text" style="width: 500px;border:0" name ="usersBornAddr" id="usersBornAddr" value="${requestScope. reFormDateStu. stuInfo.usersBornAddr}"></td>
			</tr>
			<tr>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="현 거주지 주소" disabled></th>
				<td colspan="5" style="height: 34px; text-align:center;"><input type="text" style="width: 500px;border:0" name ="usersCurrentAddr" id="usersCurrentAddr" value="${requestScope. reFormDateStu. stuInfo.usersCurrentAddr}"></td>
			</tr>
			<tr>
				<th align="center"><input type="text" style="height: 40px" class="form-control" placeholder="국적" disabled></th>
				<td style="height: 34px; text-align:center;">${requestScope.reFormDateStu.stuInfo.usersNational}</td>
				<th align="center" ><input type="text"  style="height: 40px"class="form-control" placeholder="집 전화번호" disabled></th>
				<td style="height: 34px; text-align:center;"><input type="text" name ="usersPhoneNum" style="border: 0" id="usersPhoneNum" value="${requestScope. reFormDateStu. stuInfo.usersPhoneNum}"></td>
				<th align="center"><input type="text"  style="height: 40px"class="form-control" placeholder="핸드폰 번호" disabled></th>
				<td style="height: 34px; text-align:center;"><input type="text" name ="usersCellNum" style="border: 0" id="usersCellNum" value="${requestScope. reFormDateStu. stuInfo.usersCellNum}"></td>
			</tr>
			<tr>
				<th align="center"><input type="text"  style="height: 40px"class="form-control" placeholder="이메일" disabled></th>
				<td colspan="5" style="height: 34px; text-align:center;"><input type="text" name ="usersEmail" style="width: 500px;border:0" id="usersEmail" value="${requestScope. reFormDateStu. stuInfo.usersEmail}" ></td>
			</tr>
		</thead>
	</table><br>
	<input type="hidden" name="usersPassword" value="${requestScope.reFormDateStu.stuInfo.usersPassword}">
	<center><input type="submit" id="upBtn" value="수정" ></center><br>
	</form> 
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button onclick="location.href='${initParam.rootPath}/student/moveUpdatePwd.do'" type="button" style="color:white; background-color:#ffb937; border:0px; border-radius:10px;height:40px;">비밀번호 변경 페이지로 이동</button>&nbsp;&nbsp;
<button onclick="location.href='${initParam.rootPath}/index.do'" type="button" style="color:white; background-color:#ffb937; border:0px; border-radius:10px;height:40px;">메인화면으로 가기</button>
</body>
</html>