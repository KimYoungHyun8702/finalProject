...
<br>
   ...
   <br><br><table id="selectSubject" border="2">
      <thead>
         <tr>
           ...
           <th><input style="width:65px" type='text' class='form-control' placeholder='학점' disabled></th>
           <th><input style="width:65px" type='text' class='form-control' placeholder='정원' disabled></th>
           <th><input style="width:60px" type='text' class='form-control' placeholder='학년' disabled></th>
           ...
           <th><input style="width:65px" type='text' class='form-control' placeholder='수정' disabled></th>
