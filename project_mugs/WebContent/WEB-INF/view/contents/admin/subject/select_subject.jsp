...
$(document).ready(function(){   
      ...
      if($("#time").val() == '시간표 선택'){
         ...
         $.ajax({
            ...
            "success":function(result){
               var txt1 = "";
               $.each(result,function(){
               txt1 += "<tr><td align='center'>"+this.subjectName+"</td><td align='center'>"+this.subjectTime+"</td><td align='center'>"+this.subjectType+"</td><td align='center'>"
                      +this.subjectCredit+"</td><td align='center'>"   +this.subjectCapacity+"</td><td align='center'>"+this.subjectGrade+"</td><td align='center'>"
   ...
   $("#majorButton").on("click",function(){
      ...
      $.ajax({
         ...
         "success":function(result){
               var txt1 = "";
               txt1 += "<tr><td align='center'>"+result.subjectName+"</td><td align='center'>"+result.subjectTime+"</td><td align='center'>"+result.subjectType+"</td><td align='center'>"
                     +result.subjectCredit+"</td><td align='center'>"+result.subjectCapacity+"</td><td align='center'>"+result.subjectGrade+"</td><td align='center'>"
...
<br>
   ...
   <center><br><table id="selectSubject" border="1">
      <thead>
         <tr>
           <th><input style="width:100px" type='text' class='form-control' placeholder='과목명' disabled></th>
           <th><input style="width:120px" type='text' class='form-control' placeholder='강의시간' disabled></th>
           <th><input style="width:80px" type='text' class='form-control' placeholder='이수구분' disabled></th>
           <th><input style="width:60px" type='text' class='form-control' placeholder='학점' disabled></th>
           <th><input style="width:60px" type='text' class='form-control' placeholder='정원' disabled></th>
           <th><input style="width:55px" type='text' class='form-control' placeholder='학년' disabled></th>
           <th><input style="width:55px" type='text' class='form-control' placeholder='분반' disabled></th>
           <th><input style="width:80px" type='text' class='form-control' placeholder='폐강여부' disabled></th>
           <th><input style="width:80px" type='text' class='form-control' placeholder='학기' disabled></th>
           <th><input style="width:100px" type='text' class='form-control' placeholder='학과' disabled></th>
           <th><input style="width:100px" type='text' class='form-control' placeholder='강의동' disabled></th>
           <th><input style="width:100px" type='text' class='form-control' placeholder='강의실' disabled></th>
           <th><input style="width:60px" type='text' class='form-control' placeholder='수정' disabled></th>
           <th><input style="width:60px" type='text' class='form-control' placeholder='삭제' disabled></th>
         </tr>
      </thead>
      <tbody id="tbody1"></tbody>
   </table></center><br>
   <center><button onclick="location.href='${initParam.rootPath}/index.do'" type="button" style="color:white; background-color:#ffb937; border:0px; border-radius:10px;height:50px;">메인화면으로 가기</button></center>
</body>