                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-pencil text-primary"></span><a href="${initParam.rootPath }/professor/professorInfo.do" class="side-menu">교수개인정보조회</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div id="collapseOne3" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table class="table">
                                <tr>
                                    <td>
                                        <span class="glyphicon glyphicon-pencil text-primary"></span><a href="${initParam.rootPath }/professor/addStudentGrade.do" class="side-menu">성적주기</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
